...
.method private static a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/animation/AnimatorSet;IF)Landroid/animation/Animator;
    ...
    invoke-static/range {v1 .. v6}, Landroid/support/b/a/e;->a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;FLorg/xmlpull/v1/XmlPullParser;)Landroid/animation/ObjectAnimator;
    ...
    invoke-static/range {v1 .. v7}, Landroid/support/b/a/e;->a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Landroid/animation/ValueAnimator;FLorg/xmlpull/v1/XmlPullParser;)Landroid/animation/ValueAnimator;
    ...
    sget-object v1, Landroid/support/b/a/a;->h:[I

    move-object/from16 v0, p4

    invoke-static {p1, p2, v0, v1}, Landroid/support/v4/b/a/c;->a(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {v12, v0, v1, v2, v3}, Landroid/support/v4/b/a/c;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    invoke-static {p0, p1, p2, v0, v1}, Landroid/support/b/a/e;->a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)[Landroid/animation/PropertyValuesHolder;
...
.method private static a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Landroid/animation/PropertyValuesHolder;
    ...
    invoke-static {v1, v4}, Landroid/support/b/a/e;->a(Landroid/animation/Keyframe;F)Landroid/animation/Keyframe;
    ...
    invoke-static {v4, v3, v2, v0}, Landroid/support/b/a/e;->a([Landroid/animation/Keyframe;FII)V
...
.method private static a(Landroid/content/res/TypedArray;IIILjava/lang/String;)Landroid/animation/PropertyValuesHolder;
    ...
    invoke-static {v6}, Landroid/support/b/a/e;->a(I)Z
    ...
    invoke-static {v3}, Landroid/support/v4/c/b;->b(Ljava/lang/String;)[Landroid/support/v4/c/b$b;
    ...
    new-instance v7, Landroid/support/b/a/e$a;

    invoke-direct {v7, v2}, Landroid/support/b/a/e$a;-><init>(Landroid/support/b/a/e$1;)V

    if-eqz v6, :cond_c

    invoke-static {v4, v6}, Landroid/support/v4/c/b;->a([Landroid/support/v4/c/b$b;[Landroid/support/v4/c/b$b;)Z
    ...
    invoke-direct {v0, v2}, Landroid/support/b/a/e$a;-><init>(Landroid/support/b/a/e$1;)V
...
.method private static a(Landroid/animation/ValueAnimator;Landroid/content/res/TypedArray;Landroid/content/res/TypedArray;FLorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {p1, p4, v0, v3, v7}, Landroid/support/v4/b/a/c;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    invoke-static {p1, p4, v0, v5, v9}, Landroid/support/v4/b/a/c;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I

    move-result v0

    const-string v5, "valueFrom"

    invoke-static {p4, v5}, Landroid/support/v4/b/a/c;->a(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {p1, v0, v6, v10, v5}, Landroid/support/b/a/e;->a(Landroid/content/res/TypedArray;IIILjava/lang/String;)Landroid/animation/PropertyValuesHolder;
