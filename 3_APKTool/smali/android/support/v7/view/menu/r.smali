...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/g;Landroid/view/View;IIZ)V
    ...
    iget-boolean v2, p0, Landroid/support/v7/view/menu/r;->f:Z

    invoke-direct {v0, p2, v1, v2}, Landroid/support/v7/view/menu/f;-><init>(Landroid/support/v7/view/menu/g;Landroid/view/LayoutInflater;Z)V
    ...
    iput v0, p0, Landroid/support/v7/view/menu/r;->g:I

    iput-object p3, p0, Landroid/support/v7/view/menu/r;->m:Landroid/view/View;

    new-instance v0, Landroid/support/v7/widget/aa;

    iget-object v1, p0, Landroid/support/v7/view/menu/r;->c:Landroid/content/Context;

    const/4 v2, 0x0

    iget v3, p0, Landroid/support/v7/view/menu/r;->h:I

    iget v4, p0, Landroid/support/v7/view/menu/r;->i:I

    invoke-direct {v0, v1, v2, v3, v4}, Landroid/support/v7/widget/aa;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/aa;
...
.method static synthetic b(Landroid/support/v7/view/menu/r;)Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/r;->j:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
...
.method private h()Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/aa;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/aa;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/aa;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/aa;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/aa;

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/aa;->a(Z)V

    iget-object v1, p0, Landroid/support/v7/view/menu/r;->b:Landroid/view/View;
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v7/view/menu/r;->k:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {v1, v0}, Landroid/view/View;->addOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/aa;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aa;->b(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/aa;

    iget v1, p0, Landroid/support/v7/view/menu/r;->s:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aa;->e(I)V
    ...
    iget v4, p0, Landroid/support/v7/view/menu/r;->g:I
    ...
    iput-boolean v2, p0, Landroid/support/v7/view/menu/r;->q:Z

    :cond_4
    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/aa;

    iget v1, p0, Landroid/support/v7/view/menu/r;->r:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aa;->g(I)V

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/aa;

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aa;->h(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aa;->a(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/aa;->e()Landroid/widget/ListView;

    move-result-object v4

    invoke-virtual {v4, p0}, Landroid/widget/ListView;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V

    iget-boolean v0, p0, Landroid/support/v7/view/menu/r;->t:Z

    if-eqz v0, :cond_6

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->d:Landroid/support/v7/view/menu/g;

    invoke-virtual {v0}, Landroid/support/v7/view/menu/g;->l()Ljava/lang/CharSequence;

    move-result-object v0

    if-eqz v0, :cond_6

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->c:Landroid/content/Context;
    ...
    iget-object v5, p0, Landroid/support/v7/view/menu/r;->d:Landroid/support/v7/view/menu/g;

    invoke-virtual {v5}, Landroid/support/v7/view/menu/g;->l()Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/r;->e:Landroid/support/v7/view/menu/f;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aa;->a(Landroid/widget/ListAdapter;)V
...
.method public a(Landroid/support/v7/view/menu/s;)Z
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/r;->b:Landroid/view/View;

    iget-boolean v4, p0, Landroid/support/v7/view/menu/r;->f:Z

    iget v5, p0, Landroid/support/v7/view/menu/r;->h:I

    iget v6, p0, Landroid/support/v7/view/menu/r;->i:I
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/r;->n:Landroid/support/v7/view/menu/m$a;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/r;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/l;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    const/4 v1, 0x0

    iput-object v1, p0, Landroid/support/v7/view/menu/r;->l:Landroid/widget/PopupWindow$OnDismissListener;

    iget-object v1, p0, Landroid/support/v7/view/menu/r;->d:Landroid/support/v7/view/menu/g;

    invoke-virtual {v1, v7}, Landroid/support/v7/view/menu/g;->a(Z)V

    iget-object v1, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/aa;

    invoke-virtual {v1}, Landroid/support/v7/widget/aa;->j()I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/aa;

    invoke-virtual {v2}, Landroid/support/v7/widget/aa;->k()I
...
.method public b(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/aa;->c(I)V
