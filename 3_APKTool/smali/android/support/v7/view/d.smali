...
.method private a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    ...
    new-instance v7, Landroid/support/v7/view/d$b;

    invoke-direct {v7, p0, p3}, Landroid/support/v7/view/d$b;-><init>(Landroid/support/v7/view/d;Landroid/view/Menu;)V
    ...
    invoke-virtual {v7, p2}, Landroid/support/v7/view/d$b;->a(Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {v7, p2}, Landroid/support/v7/view/d$b;->b(Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {v7}, Landroid/support/v7/view/d$b;->c()Landroid/view/SubMenu;

    move-result-object v5

    invoke-direct {p0, p1, p2, v5}, Landroid/support/v7/view/d;->a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    ...
    invoke-virtual {v7}, Landroid/support/v7/view/d$b;->a()V
    ...
    invoke-virtual {v7}, Landroid/support/v7/view/d$b;->d()Z

    move-result v5

    if-nez v5, :cond_1

    iget-object v5, v7, Landroid/support/v7/view/d$b;->a:Landroid/support/v4/h/c;

    if-eqz v5, :cond_9

    iget-object v5, v7, Landroid/support/v7/view/d$b;->a:Landroid/support/v4/h/c;

    invoke-virtual {v5}, Landroid/support/v4/h/c;->e()Z
    ...
    :cond_9
    invoke-virtual {v7}, Landroid/support/v7/view/d$b;->b()V
