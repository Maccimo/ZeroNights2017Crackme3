...
# static fields
.field private static final a:Landroid/support/v4/g/d;
...
.field private static final d:Landroid/support/v4/g/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Landroid/support/v4/g/d;-><init>(I)V

    sput-object v0, Landroid/support/v4/f/b;->a:Landroid/support/v4/g/d;
    ...
    sput-object v0, Landroid/support/v4/f/b;->d:Landroid/support/v4/g/g;
...
.method public static a(Landroid/content/Context;Landroid/support/v4/f/a;Landroid/widget/TextView;III)Landroid/graphics/Typeface;
    ...
    sget-object v0, Landroid/support/v4/f/b;->a:Landroid/support/v4/g/d;

    invoke-virtual {v0, v2}, Landroid/support/v4/g/d;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_1
    sget-object v0, Landroid/support/v4/f/b;->d:Landroid/support/v4/g/g;

    invoke-virtual {v0, v2}, Landroid/support/v4/g/g;->containsKey(Ljava/lang/Object;)Z
    ...
    sget-object v4, Landroid/support/v4/f/b;->d:Landroid/support/v4/g/g;

    invoke-virtual {v4, v2, v0}, Landroid/support/v4/g/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static a(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/support/v4/f/a;)Landroid/support/v4/f/b$a;
    ...
    invoke-static {p0, p2, v1, p1}, Landroid/support/v4/f/b;->a(Landroid/content/Context;Landroid/support/v4/f/a;Ljava/lang/String;Landroid/os/CancellationSignal;)[Landroid/support/v4/f/b$b;
...
.method static synthetic a()Landroid/support/v4/g/d;
    .locals 1
...
.method static a(Landroid/content/Context;Landroid/support/v4/f/a;Ljava/lang/String;Landroid/os/CancellationSignal;)[Landroid/support/v4/f/b$b;
    ...
    :goto_6
    new-instance v3, Landroid/support/v4/f/b$b;

    invoke-direct/range {v3 .. v8}, Landroid/support/v4/f/b$b;-><init>(Landroid/net/Uri;IIZI)V
    ...
    new-array v2, v2, [Landroid/support/v4/f/b$b;
...
.method static synthetic c()Landroid/support/v4/g/g;
    .locals 1
