    ...
    protected void onMeasure(int var1, int var2) {
        ...
        if (var4 != null) {
            ...
            if (var3 > 0 && var4.getEllipsisCount(var3 - 1) > 0) {
                ...
                this.setMaxLines(2);
                TypedArray var5 = this.getContext().obtainStyledAttributes((AttributeSet)null, a$j.TextAppearance, 16842817, 16973892);
                var3 = var5.getDimensionPixelSize(a$j.TextAppearance_android_textSize, 0);
                if (var3 != 0) {
